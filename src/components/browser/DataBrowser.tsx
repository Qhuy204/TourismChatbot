...
interface DataBrowserProps {
  ...
  onNavigateToAnnotate?: (recordId: string, locationName?: string) => void;
                        ...
                        <TableCell>
                          <Button size="sm" variant="ghost" onClick={() => {
                            if (onNavigateToAnnotate) {
                              // Use db_id for navigation (UUID from database) and pass location name
                              onNavigateToAnnotate(record.db_id || record.id, record.metadata.landmark_name);
                            } else {
